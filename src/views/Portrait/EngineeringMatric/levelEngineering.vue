<template>
  <el-card style="margin-top: 10px">
    <p style="font-size: 20px; font-weight: bold">职级工程指标统计</p>
    <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
      <el-submenu index="1">
        <template slot="title">职级产出</template>
      ...
      <!-- <el-submenu index="2">
        <template slot="title">职级效率</template>
      ...
      <el-submenu index="3">
        <template slot="title">职级发布</template>
      ...
      <!-- <el-submenu index="4">
        <template slot="title">职级质量</template>
      ...
      <el-submenu index="5">
        <template slot="title">职级成本</template>
...
export default {
  ...
  methods: {
    handleSelect(key, keyPath) {
      switch (keyPath[1]) {
        case '1-1':
          this.draw5(this.levelProportion.devEquivalentList, '开发当量')
          this.draw6(this.levelTendency.devEquivalentTendencyList, this.levelTendency.monthList, '开发当量');
          break;
        case '1-2':
          this.draw5(this.levelProportion.codeLineList, '代码行数')
          this.draw6(this.levelTendency.codeListTendencyList, this.levelTendency.monthList, '代码行数');
          break;
        case '1-3':
          this.draw5(this.levelProportion.commitList, '代码提交次数')
          this.draw6(this.levelTendency.commitTendencyList, this.levelTendency.monthList, '代码提交次数');
          break;
        case '3-1':
          this.draw5(this.levelProportion.publishList, '发布次数')
          this.draw6(this.levelTendency.publishTendencyList, this.levelTendency.monthList, '发布次数');
          break;
        case '3-2':
          this.draw5(this.levelProportion.compileList, '编译次数')
          this.draw6(this.levelTendency.compileTendencyList, this.levelTendency.monthList, '编译次数');
          break;
        case '3-3':
          this.draw5(this.levelProportion.onlineList, '上线次数')
          this.draw6(this.levelTendency.onlineTendencyList, this.levelTendency.monthList, '上线次数');
          break;
        case '3-4':
          this.draw5(this.levelProportion.restartList, '重启次数')
          this.draw6(this.levelTendency.rollbackTendencyList, this.levelTendency.monthList, '重启次数');
          break;
        case '3-5':
          this.draw5(this.levelProportion.rollbackList, '回滚次数')
          this.draw6(this.levelTendency.restartTendencyList, this.levelTendency.monthList, '回滚次数');
          break;
        default:
          break;
      }
